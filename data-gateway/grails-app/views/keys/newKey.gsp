...
<html>
	...
	<body>
		...
		<div id="page-body" role="main">
			<g:if test="${ ! apiKey }">
				<h1>Key Creation Failed</h1>
				<p>Hm...that didn't seem to work.  Looks like you're pretty screwed.
				</p>
				<p>Maybe check your database settings and try again?
				</p>
			</g:if>
			<g:else>
				<h1>API Key Created</h1>
				<p>Below you can find the details of your new API key.  Note that you should use your key like this:  
				</p>
				<pre class="code">&lt;script src='http://&lt;your_server_address&gt;${createLink(uri: "/api/client?apiKey=")}${ apiKey.apiKey }'&gt;
&lt;/script&gt;</pre>
				<table class="keysTable">
					...
					<tbody>
						<tr>
							<td>${ apiKey.apiKey }</td>
							<td style="cursor: pointer;" onclick="this.innerHTML = '${ apiKey.secretKey }'">(click to view)</td>
						</tr>
					</tbody>
				</table>
